    ...
    >
      <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "4.5rem" }}>
          ...
          >
            LET'S BUILD{" "}
            <span style={{ color: "#E8A020" }}>TOGETHER</span>
          </h2>
        </div>
        ...
        >
          {/* Contact Info */}
          <div style={{ background: "#1A1A1A", padding: "3rem" }}>
            <h3
              style={{
                fontFamily: "'Barlow Condensed', sans-serif",
                fontWeight: 700,
          ...
          {/* Form */}
          <div style={{ background: "#161616", padding: "3rem" }}>
            {submitted ? (
              <div
                style={{
                  display: "flex",
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem" }} className="form-row">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="residential" style={{ background: "#1a1a1a" }}>Residential Construction</option>
                      <option value="commercial" style={{ background: "#1a1a1a" }}>Commercial Buildings</option>
                      <option value="infrastructure" style={{ background: "#1a1a1a" }}>Infrastructure</option>
                      <option value="renovation" style={{ background: "#1a1a1a" }}>Renovation & Remodeling</option>
                    </select>
                  </div>
                </div>
