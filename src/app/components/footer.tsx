...
const footerLinks = {
  ...
  Services: ["Residential Construction", "Commercial Buildings", "Infrastructure", "Renovation"],
    ...
    <footer style={{ background: "#0A0A0A", borderTop: "3px solid #E8A020" }}>
      ...
      >
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1.5rem" }}>
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M12 2L4 7v10l8 5 8-5V7L12 2z" fill="#111111" />
                <path d="M12 6l-4 2.5v5L12 16l4-2.5v-5L12 6z" fill="#E8A020" />
              </svg>
            </div>
            <div>
              <div
          ...
          >
            Building Cebu's future since 1999. A PCAB-licensed construction
            and development company dedicated to quality, integrity, and
            on-time delivery.
          </p>
