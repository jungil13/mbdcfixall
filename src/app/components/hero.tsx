    ...
    >
      ...
      >
        <div style={{ maxWidth: "760px" }}>
          ...
          >
            <div style={{ width: "40px", height: "2px", background: "#E8A020" }} />
            <span
              style={{
          ...
          >
            BUILDING
            <br />
            <span style={{ color: "#E8A020" }}>CEBU'S</span>
            <br />
            FUTURE
          </h1>
          ...
          >
            ...
            development projects across Cebu — on time, on budget, and built to last.
          </p>
